...
class VClassifier(private var context: Context, private val modelName: String) {
    ...
    companion object {
        const val IMAGENET_CLASSIFY_MODEL = "movinet_a0_1f.tflite"
        const val LABEL_FILE = "vactivity.txt"
    }
}